...
export default function Home() {
  ...
  <div className="mt-40">
    ...
    <div className="container mx-auto px-4">
    <h2 className="text-3xl font- text-center mb-12">Everything you need to manage your finances</h2>
    ...
    <section className="py-20 bg-blue-100">
      <div className="container mx-auto px-4">
    <h2 className="text-3xl font- text-center mb-16">How It Works</h2>
    ...
    <section className="py-20">
    <div className="container mx-auto px-4">
    <h2 className="text-3xl font- text-center mb-12">What Our Users Say</h2>
    <div className="grid grid-cols-1  md:grid-cols-3 gap-8">
    ...
    <h2 className="text-3xl font- text-center mb-4 text-white">
      Ready To Take Control Of Your Finances?
    </h2>
    <p className="text-blue-100 mb-8 mx-auto max-w-2xl">
      join thosands of users using FinTrack to manage their money smarter and
